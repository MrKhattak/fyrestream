...
<style>
    ...
    li.tui-image-editor-item:after,
    li.tui-image-editor-item:before {
...
@push('scripts')
<script src="{{asset('js/tui/fabric.min.js')}}"></script>
<script type="text/javascript" src="https://uicdn.toast.com/tui.code-snippet/v1.5.0/tui-code-snippet.min.js"></script>
<script type="text/javascript" src="https://uicdn.toast.com/tui-color-picker/v2.2.6/tui-color-picker.js"></script>
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/FileSaver.js/1.3.3/FileSaver.min.js"></script>
<script src="{{asset('js/tui/tui.js')}}"></script>
<script src="{{asset('js/tui/tuiZoom.js')}}"></script>
<script>
    var files;
    var imageEditor;
    ...
    function handleFileChange(e) {
        /* Add side bar btns */
        document.getElementById("sidebar-to-add").innerHTML += sidebarImageEditor;

        files = e.target.files;
        document.getElementById("main-body-div").innerHTML = `
            <div id="my-image-editor" style="height: 700px;">
                <canvas></canvas>
            </div>
        `;

        imgUrl = URL.createObjectURL(files[0]);
        imageEditor = new ImageEditor('#my-image-editor', {
        ...
        document.querySelector(".tui-image-editor-header-logo > img").src = window.origin + "/logo.png";
...
<span class="tooltip" style="top: 29px; display: none;">ZoomIn</span><span class="tooltip" style="top: 26px; display: none;">ZoomOut</span><span class="tooltip" style="top: 28px; display: none;">Hand</span><span class="tooltip" style="top: 25px; display: none;">History</span><span class="tooltip" style="top: 25px; display: none;">Undo</span><span class="tooltip" style="top: 25px; display: none;">Redo</span><span class="tooltip" style="top: 25px; display: none;">Reset</span><span class="tooltip" style="top: 20px; display: none;">Delete</span><span class="tooltip" style="top: 40px; display: none;">DeleteAll</span><span class="tooltip" style="top: 632px; display: none;">Resize</span><span class="tooltip" style="top: 628px; display: none;">Crop</span><span class="tooltip" style="top: 631px; display: none;">Flip</span><span class="tooltip" style="top: 631px; display: none;">Rotate</span><span class="tooltip" style="top: 627px; display: none;">Draw</span><span class="tooltip" style="top: 643px; display: none;">Shape</span><span class="tooltip" style="top: 622px; display: none;">Icon</span><span class="tooltip" style="top: 644px; display: none;">Text</span><span class="tooltip" style="top: 624px; display: none;">Mask</span><span class="tooltip" style="top: 634px; display: none;">Filter</span>
